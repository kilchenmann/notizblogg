    ...
    if (@fopen($mediaPath, 'r') == true) {
        switch($mediaType) {
            case 'picture';
                ...
                break;
            case 'document';
                $media_tag = '<a href=\'' . $mediaURL . '\' title=\'Download ' . $media . '\'><img class=\'staticMedia download-icon\' src=\'' . __SITE_URL__ . "/app/style/img/icons/pdf.png' title='Download/Open ".$media."' alt='".$media."'/></a>";
                break;
            case 'movie';
